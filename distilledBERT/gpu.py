...
# Load your pipeline with the specified device
question_answerer = pipeline("question-answering", model="distilbert-base-cased-distilled-squad", device=0 if torch.cuda.is_available() else -1)

context = r"""
Comment: 'You are so stupid and worthless!
"""

result = question_answerer(question="Is this comment respectful?",   context=context)
